...
public final class BinarySearchTreeMethodsTest {
    ...
    @Test
    public void isInTreeTestToEmpty() {
        /*
         * Set up variables
         */
    ...
    @Test
    public void isInTreeTestToEmpty2() {
        /*
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("d");
        BinaryTree<String> t2 = createBSTFromArgs("d");
        /*
         * Call method under test
         */
        boolean inTree = BinarySearchTreeMethods.isInTree(t1, "d");
    ...
    @Test
    public void removeSmallest1() {
    	BinaryTree<String> ref = createBSTFromArgs("b", "c");
        BinaryTree<String> test = createBSTFromArgs("b","a", "c");
        assertEquals("a", BinarySearchTreeMethods.removeSmallest(test));
        assertEquals(ref, test);
    }
    @Test
    public void print() {
    	BinaryTree<String> print = createBSTFromArgs("Matt", "Zeke", "Pete", "Lon", "John", "Mei", "Larry", "Bess", "Merv", "Adam", "Kate");
