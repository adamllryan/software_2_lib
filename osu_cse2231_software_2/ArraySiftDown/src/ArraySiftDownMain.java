...
//        }
    ...
    private static void siftDown(int[] array, int top, int last) {
        //System.out.println("last: " + last + " top: " + top);
    	assert array != null : "Violation of: array is not null";
        assert 0 <= top : "Violation of: 0 <= top";
        assert last < array.length : "Violation of: last < |array|";
        ...
        if (array.length-top>1) {
        	...
        	int left = 2*top+1;
        	int right = left+1;
        	if (left <= last && array[left]<array[smallest])
        		smallest = left;
        	if (right<=last && array[right]<array[smallest])
        		smallest = right;
        	//System.out.println(" left: " + left + " smallest: " + smallest);
        	if (smallest != top) {
    ...
    public static void main(String[] args) {
        ...
        int heapSize = 10;//in.nextInteger();
        /*
