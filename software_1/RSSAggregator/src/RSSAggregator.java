...
public final class RSSAggregator {
    ...
    */
    ...
    public static void main(String[] args) throws IOException {
        ...
        SimpleWriter output = new SimpleWriter1L(directory);
        out.println("Input an xml file with RSS feeds: ");
        String feedURL = in.nextLine();
        XMLTree feed = new XMLTree1(feedURL);
        //begin index page here
        output.print("<html>\n\t"
        		+ "<head>\n\t\t"
        		+ "<title>");
        output.print(feed.attributeValue("title")); //title
        output.print("</title>\n\t\t"
        		+ "<body>\n\t\t\t"
        		+ "<h2><b>");
        ...
        output.print("</b></h2>\n\t\t\t"
        		+ "<ul>\n\t\t\t");
        //print a list item for each feed
        for (int i = 0; i<feed.numberOfChildren(); i++) {
        	output.print("\t<li><a href=\"");
        	output.print(feed.child(i).attributeValue("file"));
        	output.print("\">");
        	output.print(feed.child(i).attributeValue("name"));
        	output.print("</a></li>\n\t\t\t");
        	processFeed(feed.child(i).attributeValue("url"), feed.child(i).attributeValue("file"), out);
        }
        //closing tags
        output.print("</ul>\n\t\t"
        		+ "</body>\n\t"
