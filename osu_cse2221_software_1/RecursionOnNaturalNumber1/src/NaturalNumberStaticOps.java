...
public final class NaturalNumberStaticOps {
    ...
    private static void printWithCommas(NaturalNumber n, SimpleWriter out) {
        ...
        NaturalNumber clone = new NaturalNumber2();
        clone.copyFrom(n);
        if (clone.compareTo(new NaturalNumber2(1000))>0) {
        	
        	int d1 = clone.divideBy10();
        	int d2 = clone.divideBy10();
        	int d3 = clone.divideBy10();
        	printWithCommas(clone, out);
        	out.print("," + d3 + d2 + d1);
        } else {
        	NaturalNumber division = clone.divide(new NaturalNumber2(1000));
        	out.print(division);
        }
